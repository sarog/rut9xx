 ...
 {	
	var gpio = document.getElementById("cbid.output_control.scheduler.gpio").value
	var classN
	
	if (gpio == "DOUT1")
		classN = "schedule_dout1";
	else if (gpio == "DOUT2")
		classN = "schedule_dout2";
	else if (gpio == "DOUT3")
		classN = "schedule_dout3";
	else if (gpio == "DOUT1_2")
		classN = "schedule_dout1_2";
	else if (gpio == "DOUT1_3")
		classN = "schedule_dout1_3";
	else if (gpio == "DOUT2_3")
		classN = "schedule_dout2_3";
	else
		classN = "schedule_all";
...
function MakeVar()
{
	...
	for (var loop = 0; loop < TrObj.length; loop++)
	{
		...
		{
			if (TdObj[loop2].className == "schedule_dout1")
			{
				HiddenField.value = HiddenField.value + "1";
			}
			else if (TdObj[loop2].className == "schedule_dout2")
			{
				HiddenField.value = HiddenField.value + "2";
			}
			else if (TdObj[loop2].className == "schedule_dout3")
			{
				HiddenField.value = HiddenField.value + "3";
			}
			else if (TdObj[loop2].className == "schedule_dout1_2")
			{
				HiddenField.value = HiddenField.value + "4";
			}
			else if (TdObj[loop2].className == "schedule_dout1_3")
			{
				HiddenField.value = HiddenField.value + "5";
			}
			else if (TdObj[loop2].className == "schedule_dout2_3")
			{
				HiddenField.value = HiddenField.value + "6";
			}
			else if (TdObj[loop2].className == "schedule_all")
			{
				HiddenField.value = HiddenField.value + "7";
			}
...
function Select_All_Cells(id)
{
	...
	else
	{
		var gpio = document.getElementById("cbid.output_control.scheduler.gpio").value
		if (gpio == "DOUT1")
			Style = "schedule_dout1";
		else if (gpio == "DOUT2")
			Style = "schedule_dout2";
		else if (gpio == "DOUT3")
			Style = "schedule_dout3";
		else if (gpio == "DOUT1_2")
			Style = "schedule_dout1_2";
		else if (gpio == "DOUT1_3")
			Style = "schedule_dout1_3";
		else if (gpio == "DOUT2_3")
			Style = "schedule_dout2_3";
		else
			Style = "schedule_all";
	}
