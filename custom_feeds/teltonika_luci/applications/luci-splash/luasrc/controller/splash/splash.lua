...
function index()
	entry({"admin", "services", "splash"}, cbi("splash/splash"), _(translate("Client-Splash")), 90).i18n = "freifunk"
	entry({"admin", "services", "splash", "splashtext" }, form("splash/splashtext"), _(translate("Splashtext")), 10)
	...
	entry({"admin", "status", "splash"}, call("action_status_admin"), _(translate("Client-Splash"))).i18n = "freifunk"
