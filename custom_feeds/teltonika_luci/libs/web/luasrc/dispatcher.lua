...
function authenticator.htmlauth(validator, accs, default)
	...
	if user == "admin" then
		...
		if user and validator(user, pass) then
			...
			t = {requests = "insert", table = "EVENTS", type="Web UI", text="Authentication was successful from ".. port .. " " .. ipaddr_eth .. " " .. ipaddr ..""}
			eventlog:insert(t)
	...
	elseif user then
		...
		t = {requests = "insert", table = "EVENTS", type="Web UI", text="Authentication was not successful for nonexistent user from ".. port .. " " .. ipaddr_eth .. " " .. ipaddr ..""}
		eventlog:insert(t)
	end
	if user then
		t = {requests = "insert", table = "EVENTS", type="Web UI", text="Authentication was not successful from ".. port .. " " .. ipaddr_eth .. " " .. ipaddr ..""}
		eventlog:insert(t)
	end
	require("luci.i18n")
	require("luci.template")
	...
	if indexcache then
		...
		if cachedate then
			...
			if cachedate > realdate then
				...
				if (fs.stat(indexcache, "size") > 1024) then
