...
define KernelPackage/crypto-des/mdm9x07
  FILES:=$(LINUX_DIR)/crypto/des_generic.ko
endef
...
define KernelPackage/crypto-rng/mdm9x07
  KCONFIG:=$(filter-out CONFIG_CRYPTO_JITTERENTROPY,$(KCONFIG))
  FILES:=$(filter-out $(LINUX_DIR)/crypto/jitterentropy_rng.ko,$(FILES))
endef
...
define KernelPackage/crypto-sha256/mdm9x07
  FILES:=$(LINUX_DIR)/crypto/sha256_generic.ko
endef
