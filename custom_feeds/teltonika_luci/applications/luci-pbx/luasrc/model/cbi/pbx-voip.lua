...
m = Map (modulename, translate("SIP Accounts"),
         translate("This is where you set up your SIP (VoIP) accounts ts like Sipgate, SipSorcery, the popular Betamax providers, and any other providers with SIP settings in order to start using them for dialing and receiving calls (SIP uri and real phone calls). Click \"Add\" to add as many accounts as you wish."))
...
p = s:option(ListValue, "register", translate("Enable Incoming Calls (Register via SIP)"),
             translate("This option should be set to \"Yes\" if you have a DID \(real telephone number\) associated with this SIP account or want to receive SIP uri calls through this provider.")) 
