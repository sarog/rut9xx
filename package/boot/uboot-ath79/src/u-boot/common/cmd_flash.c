...
#if defined(CONFIG_CMD_FLASH_PROBE)
DECLARE_GLOBAL_DATA_PTR;

int do_flash_probe(cmd_tbl_t * cmdtp, int flag, int argc, char *argv[])
{
	bd_t *bd = gd->bd;
...
U_BOOT_CMD(flash_probe,  1, 1, do_flash_probe,  "probe flash\n", NULL);
#endif /* CONFIG_CMD_FLASH_PROBE */
