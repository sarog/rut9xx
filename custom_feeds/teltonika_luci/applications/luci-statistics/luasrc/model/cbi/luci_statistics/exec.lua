...
m = Map("luci_statistics",
	...
	translate("The exec plugin starts external commands to read values from or to notify external processes when certain threshold values have been reached."))
...
exec = m:section( TypedSection, "collectd_exec_input",
	...
	translate("Here you can define external commands which will be started by collectd in order to read certain values. The values will be read from stdout."))
exec.addremove = true
exec.anonymous = true
...
notify = m:section( TypedSection, "collectd_exec_notify",
	...
	translate("Here you can define external commands which will be started by collectd when certain threshold values have been reached. The values leading to invokation will be feeded to the the called programs stdin."))
