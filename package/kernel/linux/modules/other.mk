...
define KernelPackage/ar934x-hs-uart
	SUBMENU:=$(OTHER_MENU)
	TITLE:=AR934x driver for HS UART
	KCONFIG:= \
		CONFIG_SERIAL_AR934X=y \
		CONFIG_SERIAL_AR934X_HS_CONSOLE=y
	#FILES:=$(LINUX_DIR)/drivers/tty/serial/ar934x_hs_uart.ko
	#AUTOLOAD:=$(call AutoLoad,30,ar934x_hs_uart)
endef

define KernelPackage/ar934x-hs-uart/description
	AR934x driver for HS UART.
endef

$(eval $(call KernelPackage,ar934x-hs-uart))
