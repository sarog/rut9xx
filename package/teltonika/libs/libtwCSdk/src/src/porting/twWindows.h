...
#endif
/**
* /* Thingworx integration - rand_r is not defined in windows hence using srand
* as the srand takes unsigned int dereference the pointer 
*/
#define rand_r(A) srand(*A)
