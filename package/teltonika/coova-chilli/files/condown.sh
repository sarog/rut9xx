...
logger -t "hotspot" "User ${USER_NAME} logged out."

#Script executed after a session has moved from authorized state to unauthorized. Executed with the following environment variables:
#
