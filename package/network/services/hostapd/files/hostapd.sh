...
hostapd_common_add_bss_config() {
	...
	config_add_string osu_ssid hs20_operating_class hs20_t_c_filename hs20_t_c_timestamp hs20_wan_status hs20_wan_dw_speed hs20_wan_up_speed
...
append_anqp_3gpp_cell_net() {
	if [ -z "$anqp_3gpp_cell_net_conf" ]; then
		anqp_3gpp_cell_net_conf="$1"
	else
		anqp_3gpp_cell_net_conf="$anqp_3gpp_cell_net_conf:$1"
	fi
}
...
hostapd_set_bss_options() {
	...
	json_get_vars \
		...
		multicast_to_unicast per_sta_vif interworking hs20
	...
	local hs20 disable_dgaf osen anqp_domain_id hs20_deauth_req_timeout \
		osu_ssid hs20_operating_class hs20_t_c_filename hs20_t_c_timestamp \
		hs20_t_c_server_url osu_friendly_name hs20_wan_status hs20_wan_dw_speed \
		hs20_wan_up_speed
