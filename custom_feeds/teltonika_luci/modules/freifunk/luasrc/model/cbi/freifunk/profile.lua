...
if community == nil then
	...
	m = Map(community, "Community settings", translate("These are the settings of your local community."))
	...
	prefix = c:option(Value, "mesh_network", "Mesh prefix")
	prefix.rmempty = false

	splash_net = c:option(Value, "splash_network", "Network for client DHCP addresses")
	splash_net.rmempty = false

	splash_prefix = c:option(Value, "splash_prefix", "Client network size")
