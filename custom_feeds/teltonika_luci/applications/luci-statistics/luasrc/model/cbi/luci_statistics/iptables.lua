...
m = Map("luci_statistics",
	...
	translate("The iptables plugin will monitor selected firewall rules and collect informations about processed bytes and packets per rule."))
...
rule = m:section( TypedSection, "collectd_iptables_match",
	...
	translate("Here you can define various criteria by which the monitored iptables rules are selected."))
rule.addremove = true
rule.anonymous = true
