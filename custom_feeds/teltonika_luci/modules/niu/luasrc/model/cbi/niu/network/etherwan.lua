...
nm = s:taboption("general", Value, "netmask", translate("IPv4-Netmask"))
nm.rmempty = true
...
gw = s:taboption("general", Value, "gateway", translate("IPv4-Gateway"))
...
if has_ipv6 then
	ip6addr = s:taboption("expert", Value, "ip6addr", translate("IPv6-Address"), translate("CIDR-Notation: address/prefix"))
	ip6addr:depends("proto", "static")

	ip6gw = s:taboption("expert", Value, "ip6gw", translate("IPv6-Gateway"))
	ip6gw:depends("proto", "static")
end

dns = s:taboption("expert", Value, "dns", translate("DNS-Server"))
dns:depends("peerdns", "")
...
srv = s:taboption("general", Value, "server", translate("PPTP-Server"))
