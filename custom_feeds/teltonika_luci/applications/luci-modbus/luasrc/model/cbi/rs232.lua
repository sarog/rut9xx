...
local m = Map("modbus_serial_master", translate("RS232"), translate("Modbus RS232 master periodically sends modbus requests to slave devices. Data collected from slaves is stored in a local database residing in RAM (lost after reboot)."))

s = m:section(NamedSection, "rs232", translate("RS232 configuration"),  translate("RS232 configuration"))

if (m.uci:get("rs", "rs232", "enabled") ~= "1" or m.uci:get("modbus_serial_master", "rs232", "enabled") == "1") then
	o = s:option(Flag, "enabled", translate("Enabled"), translate("Check to enable Modbus Serial Master over RS232"))
	o.rmempty = false
else
	o = s:option(DummyValue, "", "")
	o.default = "<center>Modbus Serial Master over RS232 cannot be used if <b>Services -> RS232/RS485 -> RS232 -> Enabled</b> is on.</center>"
	o.rawhtml = true
end
...
o = s:option(ListValue, "databits", translate("Data bits"))
o:value("5", "5")
o:value("6", "6")
o:value("7", "7")
o:value("8", "8")
...
o:value("none", translate("None"))
o:value("RTSCTS", translate("RTS / CTS"))
o:value("XonXoff", translate("Xon / Xoff"))
o.default = "none"
o.rmempty = false

s = m:section(TypedSection, "rs232_slave", translate("RS232 slave device's list"))
s.addremove = true
s.anonymous = true
...
function s.extedit(self, section)
	...
	return ds.build_url("admin", "services", "modbus", "modbus_serial_master", "rs232", section_id)
end
...
function s.remove(self, section)
	...
	local url = luci.dispatcher.build_url("admin", "services", "modbus", "modbus_serial_master", "rs232")
