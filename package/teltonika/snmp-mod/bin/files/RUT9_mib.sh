...
teltonika MODULE-IDENTITY
    ...
    DESCRIPTION
            \"The MIB module for TELTONIKA rut9 routers.
            \"
...
case "$(mnf_info -n)" in
RUT950*)
    echo "$conf_rut950" >$conf_file
    ;;
RUT9*)
    echo "$conf_rut9" >$conf_file
    ;;
*)
    logger -t "ioman uci_defaults" "unrecognised device"
    exit 1
    ;;
esac
