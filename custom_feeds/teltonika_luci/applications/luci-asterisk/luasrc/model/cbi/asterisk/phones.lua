...
cbimap = Map("asterisk", translate("Registered Phones"))
...
sip_table = cbimap:section(TypedSection, "sip", translate("SIP Phones"))
...
host = sip_table:option(DummyValue, "host", translate("Hostname"))
