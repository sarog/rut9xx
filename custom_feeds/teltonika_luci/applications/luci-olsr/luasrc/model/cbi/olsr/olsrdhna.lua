...
mh = Map("olsrd", translate("OLSR - HNA-Announcements"), translate("Hosts in a OLSR routed network can announce connecitivity to external networks using HNA messages."))
...
if ipv == "6and4" or ipv == "6" then
	hna6 = mh:section(TypedSection, "Hna6", translate("Hna6"), translate("IPv6 network must be given in full notation, prefix must be in CIDR notation."))
	hna6.addremove = true
	hna6.anonymous = true
