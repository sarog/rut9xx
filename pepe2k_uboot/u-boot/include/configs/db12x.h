 ...
 * ==================
 */
#if defined(CONFIG_FOR_TLT_RUT9XX)
	#define WEBFAILSAFE_UPLOAD_ART_ADDRESS CFG_FLASH_BASE + 0x30000
	#define GPIO_LED_ETH0		GPIO1
	#define GPIO_LED_ETH1		GPIO22
	#define GPIO_LED_ETH2		GPIO13
	#define GPIO_LED_ETH3	 	GPIO14
	#define GPIO_DIGITAL_IN 	GPIO2
	...
	#define CONFIG_QCA_GPIO_MASK_LED_ACT_L	GPIO_LED_ETH0 |\
						GPIO_LED_ETH1 |\
						GPIO_LED_ETH2 |\
						GPIO_LED_ETH3
	...
	#define CONFIG_QCA_GPIO_MASK_OUT	GPIO21 |\
						CONFIG_QCA_GPIO_MASK_OUT_INIT_L |\
						CONFIG_QCA_GPIO_MASK_LED_ACT_L

	#define CONFIG_QCA_GPIO_MASK_IN		GPIO_DIGITAL_IN |\
						GPIO15
