...
#define DEFAULT_THING_NAME "TwApp"
...
int main( int argc, char** argv ) {
	...
	//twLogger_SetIsVerbose(FALSE); /* Will show all messages network at TRACE level, reduces performance */
	openlog("twStreamApp", LOG_CONS | LOG_PID | LOG_NDELAY, LOG_LOCAL1);
	syslog(LOG_INFO, "twStreamApp init");
