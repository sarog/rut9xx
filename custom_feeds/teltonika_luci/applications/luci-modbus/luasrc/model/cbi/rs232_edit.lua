if arg[1] then
	...
	luci.http.redirect(ds.build_url("admin/services/modbus/modbus_serial_master/rs232/"))
end
...
m.redirect = luci.dispatcher.build_url("admin/services/modbus/modbus_serial_master/rs232/")
