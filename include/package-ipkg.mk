...
ifeq ($(DUMP),)
  define BuildTarget/ipkg
	...
	( \
		...
		echo "Source: $(SOURCE)"; \
		$(if $(PKG_ROUTER), echo "Router: $(PKG_ROUTER)"; ) \
		$(if $(PKG_FIRMWARE), echo "Firmware: $(PKG_FIRMWARE)"; ) \
		$(if $(PKG_VERSION_PM), echo "tlt_version: $(PKG_VERSION_PM)"; ) \
        $(if $(PKG_TLT_NAME), echo "tlt_name: $(PKG_TLT_NAME)"; ) \
