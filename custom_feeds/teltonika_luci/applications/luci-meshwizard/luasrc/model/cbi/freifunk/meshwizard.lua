...
m = Map("meshwizard", translate("Wizard"), translate("This wizard will assist you in setting up your router for Freifunk or another similar wireless community network."))
--m:chain("meshwizard")
