...
$(strip
  $(if $(findstring @OPENWRT,$(1)),https://sources.cdn.openwrt.org, \
    $(if $(findstring @SF,$(1)),https://downloads.sourceforge.net, \
      $(if $(findstring @APACHE,$(1)),https://mirror.netcologne.de/apache.org, \
        $(if $(findstring @GITHUB,$(1)),https://raw.githubusercontent.com, \
          $(if $(findstring @GNU,$(1)),https://mirror.csclub.uwaterloo.ca/gnu, \
            $(if $(findstring @SAVANNAH,$(1)),https://mirror.netcologne.de/savannah, \
              $(if $(findstring @KERNEL,$(1)),https://cdn.kernel.org/pub, \
                $(if $(findstring @GNOME,$(1)),https://mirror.csclub.uwaterloo.ca/gnome/sources, \
